'''
Script for pretraining a Large Language Model from Power Law Decoder Representations v900 (PLDR-LLM v900)
on multiple ranks with Refined Web dataset.
...
import pldr_model_v900 as hvdpldrm
...
def main():
    ...
    save_model_path = "pldr_llm_v900_sample_model"
    ...
    pldr_model = hvdpldrm.PLDR_Model( 
                    ...
                    A_dff=hpdict["A_dff"],
                    A_dff_depth=hpdict["A_dff_depth"],
    ...
    def train_step(inp, first_batch):
        ...
        with tf.GradientTape() as tape:
            predictions, _, _ = pldr_model([tar_inp, combined_mask], 

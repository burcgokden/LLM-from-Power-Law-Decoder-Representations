'''
Model Implementation for Large LAngiage Model from Power Law Decoder Representations v500 (PLDR-LLM-v500)
'''

import tensorflow as tf
import keras_nlp
import power_law_attention_layer_v500 as plgatt
import contextlib
...
class PLDR_DecoderLayer(tf.keras.layers.Layer):
    ...
    def __init__(self, d_model, num_heads, dff, rate=0.0, att_dropout_rate_in=0.0, att_dropout_rate_eij=0.0,
                 Adropout_rate=0.0, A_dff=None, num_reslayerA=None, num_denseA=None, activation=tf.nn.silu, **kwargs):
        ...
        self.mha1 = plgMultiHeadAttention(self.d_model, self.num_heads, self.att_dropout_rate_in,
                                       self.att_dropout_rate_eij, self.Adropout_rate, self.A_dff,
                                       self.num_reslayerA, self.num_denseA, self.activation)
...
class PLDR_Decoder(tf.keras.layers.Layer):
    ...
    def __init__(self, num_layers, d_model, num_heads, dff, target_vocab_size,
                 ...
                 Adropout_rate=0.0, A_dff=None, num_reslayerA=None, num_denseA=None, 
        ...
        self.dec_layers = [PLDR_DecoderLayer(self.d_model, self.num_heads, self.dff, self.rate, self.att_dropout_rate_in,
                                        self.att_dropout_rate_eij, self.Adropout_rate, self.A_dff,
                                        self.num_reslayerA, self.num_denseA, self.activation) for _ in range(self.num_layers)]
...
class PLDR_Model(tf.keras.Model):
    def __init__(self, num_layers, d_model, num_heads, dff, input_vocab_size,  
        ...
        self.decoder = PLDR_Decoder(self.num_layers, self.d_model, self.num_heads, self.dff,
                               self.input_vocab_size, self.rate, self.att_dropout_rate_in,
                               self.att_dropout_rate_eij, self.Adropout_rate, self.A_dff,
                               self.num_reslayerA, self.num_denseA,  self.activation)
...
class ResLayerA(tf.keras.layers.Layer):
    ...
    '''
    def __init__(self, depth, A_dff, Adropout_rate=0.0, num_denseA=None, index='0', activation=tf.nn.silu, **kwargs):
        super().__init__(**kwargs)
        self.depth=depth
        self.A_dff = A_dff
        self.Adropout_rate = Adropout_rate
        ...
        self.denseAs = [GLUVariant(self.A_dff, self.depth, name_sfx="gluA"+self.index+str(i), activation=self.activation)
